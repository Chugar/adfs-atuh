package com.adfsauth.adfsauth.security.config;
...
import com.adfsauth.adfsauth.security.auth.CustomSAMLAuthenticationProvider;


@Configuration
public class SamlSecurityBeans {
